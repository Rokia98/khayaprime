      ...
      <div className="container mx-auto px-8">
        ...
        <header className="mb-32 text-center relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-20 opacity-5 select-none pointer-events-none">
            <h2 className="font-playfair text-[180px] font-black uppercase leading-none tracking-tighter">FEMME</h2>
          </div>
          <span className="text-xs tracking-[0.8em] uppercase text-khaya-secondary font-bold mb-8 block">Maison Khaya Prime</span>
          <h1 className="font-playfair text-6xl md:text-[100px] font-black text-khaya-dark mb-12 uppercase tracking-tighter italic">L'Âme Féminine</h1>
          ...
          <p className="text-lg text-khaya-gray max-w-2xl mx-auto font-light leading-relaxed">
            Une ode à la silhouette sculpturale et au raffinement extrême. Découvrez une garde-robe pensée pour la femme qui définit ses propres règles du luxe.
          </p>
        </header>
        ...
        {products.length === 0 && (
          <div className="py-56 text-center border-2 border-dashed border-khaya-secondary/10 rounded-[3rem]">
            <p className="font-playfair text-4xl text-khaya-gray italic opacity-40">Nos ateliers peaufinent les prochaines parures...</p>
          </div>
        )}
      </div>
    </main>
